...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Vehicle.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(io.github.jhipster.application.domain.Employee.class.getName() + ".vehicles", jcacheConfiguration);
